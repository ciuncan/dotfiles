...
files="bashrc gitconfig vimperatorrc vimrc ideavimrc vim zshrc oh-my-zsh oh-my-fish private scrotwm.conf Xresources config/fish"    # list of files/folders to symlink in homedir
